...
const UserWelcomeBanner = ({ user }) => {
  return (
    <div className="bg-gradient-to-r from-primary to-blue-600 rounded-2xl p-10 min-h-[150px] mb-8 shadow-md text-white flex justify-between items-center relative overflow-hidden">
